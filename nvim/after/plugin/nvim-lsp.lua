...
if not module_checker.IsModuleAvailable('mason') or not module_checker.IsModuleAvailable("mason-lspconfig") then
  return
end
...
local on_attach = function(client, bufnr)
  ...
  --   buf_set_keymap("n", "<space>fc", "<cmd>lua vim.lsp.buf.range_formatting()<CR>", opts)
  -- end
