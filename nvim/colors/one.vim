...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  call <sid>X('StatusLineNC', s:syntax_bg,        '',               '')
  ...
  " Vim diff colors ---------------------------------------------------------
  call <sid>X('DiffAdd',      s:syntax_bg, s:hue_4,     s:italic)
  call <sid>X('DiffChange',   s:syntax_bg, s:hue_1,     'none')
  call <sid>X('DiffDelete',   s:syntax_bg, s:hue_5,     'none')
  call <sid>X('DiffText',     s:syntax_fg, s:vertsplit, 'bold')
  ...
  call <sid>X('LspDiagnosticsFloatingError',          s:hue_5 , s:pmenu, '')
  call <sid>X('LspDiagnosticsFloatingWarning',        s:hue_6_2 , s:pmenu, '')
  call <sid>X('LspDiagnosticsFloatingInformation',    s:hue_1 , s:pmenu, '')
  call <sid>X('LspDiagnosticsFloatingHint',           s:hue_4 , s:pmenu, '')
  ...
  call <sid>X('Identifier',     s:hue_5,         '',          'bold')
  call <sid>X('Function',       s:hue_2,         '',          'bold')
